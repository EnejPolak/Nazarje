export function EventsLoading({ label = 'Nalagam dogodke…' }: { label?: string }) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-[#18201B]/60">
      <div
...
export function EventsError({
  ...
  return (
    <div className="rounded-xl border border-[#9B3A32]/20 bg-[#9B3A32]/5 px-6 py-8 text-center max-w-lg mx-auto">
