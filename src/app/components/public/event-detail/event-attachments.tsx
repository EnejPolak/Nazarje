  ...
  return (
    <div className="event-detail-panel p-6 md:p-8">
      <div className="event-detail-panel-head mb-5">
        ...
        <span className="ml-auto text-xs text-[#2F5D46] bg-[#EAF1EA] px-2 py-0.5 rounded-full">
          {attachments.length}
        </span>
      </div>
        ...
        {attachments.map((attachment, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 text-xs text-[#18201B]/50 group-hover:text-[#2F5D46] transition-colors shrink-0">
